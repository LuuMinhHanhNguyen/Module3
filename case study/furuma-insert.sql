...
insert into education_background( edu_name)
values( 'HighSchool'),
( 'College'),
( 'University'),
( "PostGraduate");

insert into falcuty( falcuty_name)
values( 'Sale-Maketing'),
( 'HR'),
( 'Service'),
( 'Management');

insert into employee(employee_name, dob, id_number, salary,phone_number, email, address, role_id, edu_id, falcuty_id)
...
insert into customer(customer_name, customer_dob, gender, id_card_num, phone_num, email, address, customer_type_id)
values("Nguyễn Thị Hào","1970-11-07",0, 643431213,"	0945423362",	"thihao07@gmail.com",	"23 Nguyễn Hoàng, Đà Nẵng",	5);
insert into customer(customer_name, customer_dob, gender, id_card_num, phone_num, email, address, customer_type_id)
values("Phạm Xuân Diệu","1992-08-08",	1,	865342123,	"0954333333",	"xuandieu92@gmail.com",	"K77/22 Thái Phiên, Quảng Trị",	3),
...
insert into hiring_type(hiring_type_name)
values("year"),("month"),("day"), ("hour");

insert into service_type(service_type_name)
values("Villa"),("House"), ("Room");

insert into service(service_name, areas, hiring_cost, max_capacity, room_standard, other_service_description, pool_area, num_of_floors,hiring_type_id, service_type_id)
...
insert into complimentary(complimentary_name, price, unit, complimentary_status)
...
insert into contract_details(quantity, contract_id, complimentary_id)
values(5	,2	,4),
(8	,2	,5),
(15,	2	,6),
(1	,3,	1),
