...
import com.example.ss12demousermanagement.service.IUserService;
import com.example.ss12demousermanagement.service.UserService;
...
public class UserServlet extends HttpServlet {
    ...
    private void searchByCountry(HttpServletRequest request, HttpServletResponse response) {
        ...
        List<User> searchedUsers = iUserService.searchByCountry(searchInfo);
    ...
    private void sortedByName(HttpServletRequest request, HttpServletResponse response) {
        List<User> sortedUsers = iUserService.sortedByName();
    ...
    private void showEditForm(HttpServletRequest request, HttpServletResponse response) {
        ...
        User editedUser = iUserService.selectUser(id);
    ...
    private void editUser(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            iUserService.updateUser(editedUser);
